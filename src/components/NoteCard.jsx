...
const NoteCard = ({note}) => {
    ...
    const body=`${note.body.split("").slice(0,160).join(" ")}...`
    const color=note.category=="BUSINESS"?'purple':note.category=="PERSONAL"?'green':'purple'
  return (
    <div className="col-md-4 single-note-item all-category">
                <div className="card card-body">
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <span className="mr-1"><MdMarkunread style={{fontSize: "25px", cursor:"pointer", color: color,}}/>{note.category}</span>
                        </Link>
